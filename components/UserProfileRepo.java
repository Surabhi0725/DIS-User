...
public class UserProfileRepo {
  ...
  /*
    For all user related repository mention above, there are only 3 methods for each of them
    1. Add and Update
    2. Get
    3. Delete
  */
  ...
  public List<UserCulturalActivityAchievement> getUserCulturalActivityAchievement(
          final String userId) throws InternalServerError {
  ...
  public void deleteUserCulturalActivityAchievementById(
          final Long userCulturalActivityAchievementId) throws InternalServerError {
  ...
  public void addOrUpdateUserOtherAchievement(final UserOtherAchievement userOtherAchievement)
          throws InternalServerError {
  ...
  public List<UserOtherAchievement> getUserOtherAchievement(final String userId)
          throws InternalServerError {
  ...
  public void deleteUserOtherAchievementById(final Long userOtherAchievementId)
          throws InternalServerError {
    try {
  ...
  public UserOtherAchievement getUserOtherAchievementById(final long id) {
    ...
    Optional<UserOtherAchievement> userOtherAchievementOptional = userOtherAchievementRepository.findById(
            id);
  ...
  public UserCompetitiveExam getUserCompetitiveExamById(final long id) {
    ...
    Optional<UserCompetitiveExam> userCompetitiveExamOptional = userCompetitiveExamRepository.findById(
            id);
  ...
  public UserCulturalActivityAchievement getUserCulturalActivityAchievementById(final long id) {
    ...
    Optional<UserCulturalActivityAchievement> userCulturalActivityAchievementOptional = userCulturalActivityAchievementRepository
            .findById(id);
  ...
  public UserQualification getUserQualificationById(final long id) {
    ...
    Optional<UserQualification> userQualificationOptional = userQualificationRepository.findById(
            id);
  ...
  public UserTechnicalActivity getUserTechnicalActivityById(final long id) {
    ...
    Optional<UserTechnicalActivity> userTechnicalActivityOptional = userTechnicalActivityRepository.findById(
            id);
  ...
  public UserWorkExperience getUserWorkExperienceById(final long id) {
    ...
    Optional<UserWorkExperience> userWorkExperienceOptional = userWorkExperienceRepository.findById(
            id);
  ...
  public List<ProfilePicture> getActiveProfilePictureByUserId(final String userId)
    ...
    try {
      List<ProfilePicture> profilePictures = profilePictureRepository.findByUserIdAndStatus(userId,
              1
      );
