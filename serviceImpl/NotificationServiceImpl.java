...
public class NotificationServiceImpl implements NotificationService {
  ...
  public NotificationServiceImpl(
          @Qualifier("notificationServiceRepository") NotificationRepository notificationRepository,
  ...
  @Override
  public List<NotificationDto> getAllNotification(final String username)
  ...
  @Override
  public void sendNotificationToParticipants(final Notification notification,
  ...
  @Override
  public void sendNotificationByTypeExceptGivenUsers(final Notification notification,
          final List<String> typeList, final List<String> usernameList) {
    final Notification savedNotification = notificationRepository.save(notification);
    final List<User> participants = userRepository.findAllByUserTypeInAndUsernameNotIn(typeList,
            usernameList
    );
    participants.forEach(participant -> saveParticipant(savedNotification, participant));
    //sendToUserWebsocket(savedNotification, participants);
  ...
  private NotificationDto notificationDtoMapper(NotificationParticipant participant) {
    return new NotificationDto(participant.getNotification().getId(),
            ...
            participant.getNotification().getDescription(), participant.getNotification().getLink(),
            participant.getReadStatus(), participant.getNotification().getCreatedDate()
    );
  }
}
