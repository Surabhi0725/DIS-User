...
public class UserProjectService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserProjectDto> userProjectDtoList = userProfileDtoMapper.convertUserProjectListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserProject userProject = userProfileRepo.getUserProjectById(id);
  ...
  public void addUserProfileElement(final UserProjectDto userProjectDto, final String token)
    ...
    final UserProject userProject = userProfileDtoMapper.convertUserProjectDtoIntoModel(
            userProjectDto);
    ...
    if (0 == userProject.getId()) {
      ...
      final UserProject userProjectExisting = userProfileRepo.getUserProjectById(
              userProject.getId());
