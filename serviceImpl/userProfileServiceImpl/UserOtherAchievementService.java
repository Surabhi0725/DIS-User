...
public class UserOtherAchievementService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserOtherAchievementDto> userOtherAchievementDtoList = userProfileDtoMapper.convertUserOtherAchievementListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserOtherAchievement userOtherAchievement = userProfileRepo.getUserOtherAchievementById(
            id);
  ...
  public void addUserProfileElement(final UserOtherAchievementDto userOtherAchievementDto,
    ...
    final UserOtherAchievement userOtherAchievement = userProfileDtoMapper.convertUserOtherAchievementDtoIntoModel(
            userOtherAchievementDto);
    ...
    if (0 == userOtherAchievement.getId()) {
      ...
      final UserOtherAchievement userOtherAchievementExisting = userProfileRepo.getUserOtherAchievementById(
              userOtherAchievement.getId());
