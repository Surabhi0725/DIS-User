...
public class UserCulturalActivityAchievementService implements UserProfileService {
  ...
  private final static Logger LOGGER = LoggerFactory.getLogger(
          UserCulturalActivityAchievement.class);
  ...
  @Override
  public List<UserProfileDto> getUserProfileElement(final String userId)
          throws InternalServerError {

    LOGGER.info("fetching cultural Achievements for user id : " + userId);

    final List<UserCulturalActivityAchievementDto> userCulturalActivityAchievementDtoList = userProfileDtoMapper
            .convertUserCulturalActivityAchievementListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserCulturalActivityAchievement userCulturalActivityAchievement = userProfileRepo.getUserCulturalActivityAchievementById(
            id);
  ...
  public void addUserProfileElement(
    ...
    final UserCulturalActivityAchievement userCulturalActivityAchievement = userProfileDtoMapper.convertUserCulturalActivityAchievementDtoIntoModel(
            userCulturalActivityAchievementDto);

    LOGGER.info("Adding or Updating userElement for id : " +
            userCulturalActivityAchievement.getUserId());
    ...
    if (0 == userCulturalActivityAchievement.getId()) {
      ...
      userCulturalActivityAchievement.setCreatedBy(
              userCulturalActivityAchievementExisting.getCreatedBy());
      userCulturalActivityAchievement.setCreatedDate(
              userCulturalActivityAchievementExisting.getCreatedDate());
    }
