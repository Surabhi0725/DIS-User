...
public class UserInternshipService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserInternshipDto> userInternshipDtoList = userProfileDtoMapper.convertUserInternshipListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserInternship userInternship = userProfileRepo.getUserInternshipById(id);
  ...
  public void addUserProfileElement(final UserInternshipDto userInternshipDto, final String token)
    ...
    final UserInternship userInternship = userProfileDtoMapper.convertUserInternshipDtoIntoModel(
            userInternshipDto);
    ...
    if (0 == userInternship.getId()) {
      ...
      final UserInternship userInternshipExisting = userProfileRepo.getUserInternshipById(
              userInternship.getId());
