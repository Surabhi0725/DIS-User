...
public class UserCompetitiveExamService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserCompetitiveExamDto> userCompetitiveExamDtoList = userProfileDtoMapper.convertUserCompetitiveExamListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserCompetitiveExam userCompetitiveExam = userProfileRepo.getUserCompetitiveExamById(id);
  ...
  public void addUserProfileElement(final UserCompetitiveExamDto userCompetitiveExamDto,
    ...
    final UserCompetitiveExam userCompetitiveExam = userProfileDtoMapper.convertUserCompetitiveExamDtoIntoModel(
            userCompetitiveExamDto);
    ...
    if (0 == userCompetitiveExam.getId()) {
      ...
      final UserCompetitiveExam userCompetitiveExamExisting = userProfileRepo.getUserCompetitiveExamById(
              userCompetitiveExam.getId());
