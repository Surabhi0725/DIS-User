...
public class UserQualificationService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserQualificationDto> userQualificationDtoList = userProfileDtoMapper.convertUserQualificationListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserQualification userQualification = userProfileRepo.getUserQualificationById(id);
  ...
  public void addUserProfileElement(final UserQualificationDto userQualificationDto,
    ...
    final UserQualification userQualification = userProfileDtoMapper.convertUserQualificationDtoIntoModel(
    ...
    if (0 == userQualification.getId()) {
      ...
      final UserQualification userQualificationExisting = userProfileRepo.getUserQualificationById(
