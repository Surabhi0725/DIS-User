...
public class UserResearchWorkService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserResearchWorkDto> userResearchWorkDtoList = userProfileDtoMapper.convertUserResearchWorkListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserResearchWork userResearchWork = userProfileRepo.getUserResearchWorkById(id);
  ...
  public void addUserProfileElement(final UserResearchWorkDto userResearchWorkDto,
    ...
    final UserResearchWork userResearchWork = userProfileDtoMapper.convertUserResearchWorkDtoIntoModel(
            userResearchWorkDto);
    ...
    System.out.println(userResearchWork.getUserId());
    ...
    if (0 == userResearchWork.getId()) {
      ...
      final UserResearchWork userResearchWorkExisting = userProfileRepo.getUserResearchWorkById(
              userResearchWork.getId());
