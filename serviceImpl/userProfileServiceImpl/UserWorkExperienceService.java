...
public class UserWorkExperienceService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserWorkExperienceDto> userWorkExperienceDtoList = userProfileDtoMapper.convertUserWorkExperienceListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserWorkExperience userWorkExperience = userProfileRepo.getUserWorkExperienceById(id);
  ...
  public void addUserProfileElement(final UserWorkExperienceDto userWorkExperienceDto,
    ...
    final UserWorkExperience userWorkExperience = userProfileDtoMapper.convertUserWorkExperienceDtoIntoModel(
            userWorkExperienceDto);

//    System.out.println(userWorkExperienceDto);
    System.out.println(userWorkExperience.getUserId());
    System.out.println(userWorkExperience.getId());
    ...
    if (0 == userWorkExperience.getId()) {
      ...
      final UserWorkExperience userWorkExperienceExisting = userProfileRepo.getUserWorkExperienceById(
              userWorkExperience.getId());

      System.out.println(userId);
      System.out.println(userWorkExperienceExisting.getUserId());
