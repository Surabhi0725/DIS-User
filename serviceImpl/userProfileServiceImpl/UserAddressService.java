...
public class UserAddressService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserAddressDto> userAddressDtoList = userProfileDtoMapper.convertUserAddressListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    final UserAddress userAddress = userProfileRepo.getUserAddressById(id);
  ...
  public void addUserProfileElement(final UserAddressDto userAddressDto, final String token)
          throws InternalServerError, UnauthorizedException {

    final UserAddress userAddress = userProfileDtoMapper.convertUserAddressDtoIntoModel(
            userAddressDto);
    ...
    if (0 == userAddress.getId()) {
      ...
      final UserAddress userAddressExisting = userProfileRepo.getUserAddressById(
              userAddress.getId());
