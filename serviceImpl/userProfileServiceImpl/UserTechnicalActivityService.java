...
public class UserTechnicalActivityService implements UserProfileService {
  ...
  public List<UserProfileDto> getUserProfileElement(final String userId)
    ...
    final List<UserTechnicalActivityDto> userTechnicalActivityDtoList = userProfileDtoMapper.convertUserTechnicalActivityListModelIntoDto(
  ...
  public void deleteUserProfileElementById(final Long id, final String token)
    ...
    LOGGER.info(
            "Deleting Technical Activity for user id : " + jwtResolver.getIdFromJwtToken(token));


    final UserTechnicalActivity userTechnicalActivity = userProfileRepo.getUserTechnicalActivityById(
            id);
  ...
  public void addUserProfileElement(final UserTechnicalActivityDto userTechnicalActivityDto,
    ...
    final UserTechnicalActivity userTechnicalActivity = userProfileDtoMapper.convertUserTechnicalActivityDtoIntoModel(
            userTechnicalActivityDto);
    ...
    if (0 == userTechnicalActivity.getId()) {
      ...
      final UserTechnicalActivity userTechnicalActivityExisting = userProfileRepo.getUserTechnicalActivityById(
              userTechnicalActivity.getId());
