...
public class UserProfilePictureController {
  ...
  public ResponseEntity<ResponseMessage> uploadProfilePicture(
    ...
    return ResponseEntity.status(HttpStatus.OK)
            .body(new ResponseMessage("Profile Picture Successfully uploaded"));
  }
  ...
  public ResponseEntity<ProfilePictureDto> getProfilePicture(HttpServletRequest request,
          @RequestParam String userId) throws InternalServerError, NotFoundException {
    ...
    return new ResponseEntity<>(profilePictureService.getUserProfilePicture(id, 1), HttpStatus.OK);
  }
}
