...
public class UserNotificationController {
  ...
  public List<NotificationDto> getUserName(
          @RequestHeader("Authorization") final String authHeader) { //HttpServletRequest request) {
    final String username = JwtResolver.getUsernameFromAuthHead(
  ...
  public void sendNotificationToAll(
          @RequestBody final SendNotificationRequestDto notificationRequest) {
  ...
  public void sendNotificationToParticipants(
          @RequestBody final SendNotificationRequestDto notificationRequest) {
  ...
  public void sendNotificationToAllExcept(
          @RequestBody final SendNotificationRequestDto notificationRequest) {
    notificationService.sendNotificationByTypeExceptGivenUsers(
            notificationRequest.getNotification(), notificationRequest.getTypeList(),
            notificationRequest.getUsernameList()
    );
  }
  ...
  public void sendNotificationByType(
          @RequestBody final SendNotificationRequestDto notificationRequest) {
