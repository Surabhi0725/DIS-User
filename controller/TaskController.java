...
import sgsits.cse.dis.user.message.response.*;
...
public class TaskController {
  ...
  public ResponseEntity<List<TaskCategoryResponse>> getTasksCategoryList() {
    return new ResponseEntity<List<TaskCategoryResponse>>(taskServiceImpl.getTaskCategoryList(),
            HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<List<SearchTaskResponse>> getAssignTasksInfo() throws NotFoundException {
    return new ResponseEntity<List<SearchTaskResponse>>(taskServiceImpl.getAssignTasksInfo(),
            HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<List<CategorySpecificTaskResponse>> getTasksFromCategoryId(
          @PathVariable("categoryId") String categoryId) throws NotFoundException {
    return new ResponseEntity<List<CategorySpecificTaskResponse>>(
            taskServiceImpl.getTasksFromCategoryId(categoryId), HttpStatus.OK);
  }
  ...
  public ResponseEntity<List<ActiveStaffListResponse>> activeStaffListResponse()
    ...
    return new ResponseEntity<List<ActiveStaffListResponse>>(userServicesImpl.getActiveStaffList(),
            HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<ResponseMessage> assignTask(@RequestBody AssignTaskForm assignTaskForm,
          HttpServletRequest request) throws ConflictException {
    return new ResponseEntity<ResponseMessage>(new ResponseMessage(
            taskServiceImpl.assignTask(assignTaskForm,
  ...
  public ResponseEntity<List<SearchTaskResponse>> searchTaskByUserId(
          @PathVariable("userId") String userId) throws NotFoundException {
    return new ResponseEntity<List<SearchTaskResponse>>(taskServiceImpl.searchTaskByUserId(userId),
            HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<List<SearchTaskResponse>> searchTaskByTaskId(
          @PathVariable("taskId") String taskId) throws NotFoundException {
    return new ResponseEntity<List<SearchTaskResponse>>(taskServiceImpl.searchTaskByTaskId(taskId),
            HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<ResponseMessage> deleteTask(@PathVariable("id") String id)
          throws ConflictException {
    taskServiceImpl.deleteTask(id);
    return new ResponseEntity<ResponseMessage>(new ResponseMessage("Tasks deleted successfully. "),
            HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<ResponseMessage> updateTaskStatus(@PathVariable("status") String status,
          @PathVariable("id") String id) {
    taskServiceImpl.updateStatus(status, id);
    return new ResponseEntity<ResponseMessage>(new ResponseMessage("Setings Updated"),
            HttpStatus.OK
    );
  }

  @ApiOperation(value = "get list by task status", response = ResponseMessage.class, httpMethod = "GET", produces = "text/plain")
  @GetMapping(path = RestAPI.GET_TASK_STATUS_LIST, produces = "application/json")
  public ResponseEntity<TaskStatusList> getTaskStatusList() {
    return ResponseEntity.ok(taskServiceImpl.fetchTaskStatusList());
  }
}
