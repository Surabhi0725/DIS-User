...
public interface UserProfileDtoMapper {
  ...
  UserResearchWorkDto convertUserResearchWorkModelIntoDto(final UserResearchWork userResearchWork);
  ...
  UserInternshipDto convertUserInternshipModelIntoDto(final UserInternship userInternship);

  UserInternship convertUserInternshipDtoIntoModel(final UserInternshipDto userInternshipDto);
  ...
  UserProjectDto convertUserProjectModelIntoDto(final UserProject userProject);

  UserProject convertUserProjectDtoIntoModel(final UserProjectDto userProjectDto);

  List<UserProjectDto> convertUserProjectListModelIntoDto(final List<UserProject> userProjectList);
  ...
  UserAddressDto convertUserAddressModelIntoDto(final UserAddress userAddress);

  UserAddress convertUserAddressDtoIntoModel(final UserAddressDto userAddressDto);

  List<UserAddressDto> convertUserAddressListModelIntoDto(final List<UserAddress> userAddressList);
