...
public class SearchTaskResponse {
  ...
  public SearchTaskResponse(String id, String userId, String userName, String taskId,
          String taskName, String deadline, String description, String status, String createdDate) {
    super();
    this.id = id;
    this.userId = userId;
  ...
  public SearchTaskResponse(String id, String userId, String userName, String taskId,
          String taskName, Object deadline, Object description, Object status, String createdDate) {
    super();
    this.id = id;
    this.userId = userId;
    this.userName = userName;
